...
public class Main {
    ...
    public static int modellingTime = 50;

    public static int frequency = 50;

    public static float samplingFrequency = 80;
...
//        chapv13.setFrequencyC(ltst.getFreqC());
        ...
        achr1.getSamplingFrequency().setValue(samplingFrequency);
        achr2.getSamplingFrequency().setValue(samplingFrequency);
        achr3.getSamplingFrequency().setValue(samplingFrequency);
        achr4.getSamplingFrequency().setValue(samplingFrequency);
        achr5.getSamplingFrequency().setValue(samplingFrequency);
        achr6.getSamplingFrequency().setValue(samplingFrequency);
        achr7.getSamplingFrequency().setValue(samplingFrequency);
        achr8.getSamplingFrequency().setValue(samplingFrequency);
        achr9.getSamplingFrequency().setValue(samplingFrequency);
        achr10.getSamplingFrequency().setValue(samplingFrequency);
        achr11.getSamplingFrequency().setValue(samplingFrequency);
        achr12.getSamplingFrequency().setValue(samplingFrequency);
        achr13.getSamplingFrequency().setValue(samplingFrequency);
...
//        );
//        nhmi.addSignals(
//                new NHMISignal("UA", ltst.getMassivA()),
//                new NHMISignal("UB", ltst.getMassivB()),
//                new NHMISignal("UC", ltst.getMassivC())
//        );
        ...
        nhmi1.addSignals(
                new NHMISignal("achr9", achr9.getStepACHR())
        );
        nhmi1.addSignals(
                new NHMISignal("achr10", achr10.getStepACHR())
        );
        nhmi1.addSignals(
                new NHMISignal("achr11", achr11.getStepACHR())
        );
        nhmi1.addSignals(
                new NHMISignal("achr12", achr12.getStepACHR())
        );
        nhmi1.addSignals(
                new NHMISignal("achr13", achr13.getStepACHR())
        );
